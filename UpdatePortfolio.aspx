<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePortfolio.aspx.cs" Inherits="Final_year_Project.UpdatePortfolio" %>
...
<head>
    ...
    <title>Update Portfolio</title> <link rel="shortcut icon" href="logo.ico" />
    <style type="text/css">
        .upload-drop-zone {
            height: 200px;
            border-width: 2px;
                        ...
                        <div class="card-body">
                            <form runat="server">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label text-md-right">Company:</label>
                                    <div class="col-md-6">
                                        <%--<textarea class="form-control" id="exampleFormControlTextarea2" rows="3"></textarea>--%>
                                        <asp:TextBox ID="Company" runat="server" class="form-control" Rows="1" Width="495px" TextMode="Singleline"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator class="validation" ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="Company"></asp:RequiredFieldValidator>--%>
                                        <%--<asp:CompareValidator class="validation" ID="CompareValidator3" runat="server" Operator="DataTypeCheck" Type="Integer" ErrorMessage="Only Numbers allowed" ControlToValidate="TextBox2"></asp:CompareValidator>--%>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <%--<textarea class="form-control" id="exampleFormControlTextarea2" rows="3"></textarea>--%>
                                        <asp:TextBox ID="About" runat="server" class="form-control" Rows="3" Height="100px" Width="495px" MaxLength="240" TextMode="MultiLine"></asp:TextBox>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <%--<textarea class="form-control" id="exampleFormControlTextarea2" rows="3"></textarea>--%>
                                        <asp:TextBox ID="Cost" runat="server" class="form-control" Rows="1" Width="495px" TextMode="Singleline"></asp:TextBox>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label text-md-right">Mobile Number:</label>
                                    <div class="col-md-6">
                                        <%--<textarea class="form-control" id="exampleFormControlTextarea2" rows="3"></textarea>--%>
                                        <asp:TextBox ID="Mobile" runat="server" class="form-control" Rows="1" Width="495px" TextMode="Singleline"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator class="validation" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ControlToValidate="TextBox3"></asp:RequiredFieldValidator>--%>
                                        <%--<asp:CompareValidator class="validation" ID="CompareValidator3" runat="server" Operator="DataTypeCheck" Type="Integer" ErrorMessage="Only Numbers allowed" ControlToValidate="TextBox2"></asp:CompareValidator>--%>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label text-md-right">Email ID:</label>
                                    <div class="col-md-6">
                                        <%--<textarea class="form-control" id="exampleFormControlTextarea2" rows="3"></textarea>--%>
                                        <asp:TextBox ID="eid" runat="server" class="form-control" Rows="1" Width="495px" TextMode="Singleline"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator class="validation" ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="eid"></asp:RequiredFieldValidator>--%>
                                        <%--<asp:CompareValidator class="validation" ID="CompareValidator3" runat="server" Operator="DataTypeCheck" Type="Integer" ErrorMessage="Only Numbers allowed" ControlToValidate="TextBox2"></asp:CompareValidator>--%>
                                    </div>
                                </div>
