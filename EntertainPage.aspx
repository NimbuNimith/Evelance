<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntertainPage.aspx.cs" Inherits="Final_year_Project.EntertainPage" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Entertainers</title> <link rel="shortcut icon" href="logo.ico" />
    <meta charset="utf-8">
...
<body style="background: #1a1a1a; overflow-x: hidden;">
    ...
    <div class="imgbg1">
        <div class="caption">
            <span class="border">Entertainers</span>
        </div>
    </div>
