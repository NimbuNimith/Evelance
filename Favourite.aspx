<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Favourite.aspx.cs" Inherits="Final_year_Project.Favourite" %>
...
<body style="background: #1a1a1a; overflow-x: hidden;">
    ...
    <div class="imgbg1">
        <div class="caption">
            <span class="border">Favourites</span>
        </div>
    </div>
    <div class="sidebar-container">
        ...
        <ul class="sidebar-navigation">
            ...
            <li>
                <a href="MusicPage.aspx">
                    <img src="https://img.icons8.com/metro/26/ffffff/musical-notes.png" />Music</a>
            </li>
            <li>
        ...
        <div class="form row">
            <div class="col-md-12">
                    <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" Style="position: relative; background: #5a1a6b; color: #edd807; left: 5%; width: 90%; font-size: 25px;top:-14px;">
                    ...
                    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" Style="position: relative; background: #5a1a6b; color: #edd807; left: 5%; width: 90%; font-size: 25px; top: 14px;" >
