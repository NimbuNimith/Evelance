<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VenuePage.aspx.cs" Inherits="Final_year_Project.VenuePage" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Venues</title> <link rel="shortcut icon" href="logo.ico" />
    <meta charset="utf-8">
...
<meta name="viewport" content="width=device-width, initial-scale=1">-->
    <style>
        ...
        * {
        ...
        .imgbg2 {
            /* The image used */
            background-image: url("venue1.jpg");
