                        ...
                        <div class="row justify-content-center no-gutters">
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="form-block">
                                            ...
                                            <div class="form-group last mb-4">
                                                <label for="eidCust">Email ID
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="eidCust" ValidationGroup="a"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" class="redstar" runat="server" ErrorMessage="Invalid Email ID" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="eidCust"></asp:RegularExpressionValidator>
                                                </label>
                                            ...
                                            <div class="form-group last mb-4">
                                                <label for="mobnoCust">
                                                    Mobile no<asp:RequiredFieldValidator ID="RequiredFieldValidator4"  runat="server" ErrorMessage="*" ControlToValidate="mobnoCust" ValidationGroup="a"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="valMobnoCust" runat="server"
                                                        ControlToValidate="mobnoCust"
                                                        ErrorMessage="Please enter a valid mobile number"
                                                        ValidationExpression="^[789]\d{9}$" ForeColor="Red" />
                                                </label>
                                                <asp:TextBox ID="mobnoCust" class="form-control" runat="server" MaxLength="10"></asp:TextBox>

                                                <%--<asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="CompareValidator" ControlToValidate="mobnoCust" Type="Integer"></asp:CompareValidator>--%>
                                                <%--<input type="text" class="form-control" id="mobnoCust">--%>
                                            </div>
                                            <div class="form-group last mb-4">
                                                <label for="datepicker">Date of Birth
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="datepicker" ValidationGroup="a"></asp:RequiredFieldValidator>
                                                </label>
                                                <asp:TextBox ID="datepicker" class="form-control" runat="server" ReadOnly="True" TextMode="DateTime"></asp:TextBox>
                                                <%--<input type="text" class="form-control" id="datepicker">--%>
                                                <script>
                                                    $('#datepicker').datepicker({
                                                        showOtherMonths: true,
                                                        maxDate: new Date(2005, 2, 27),
                                                    });
                                                </script>
                                            ...
                                            <div class="form-group last mb-4">
                                                <label for="passCust">
                                                    Password
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="passCust" ValidationGroup="a"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                        ControlToValidate="passCust"
                                                        ErrorMessage="Password should be minimum 8 digits"
                                            ...
                                            <div class="form-group last mb-4">
                                                <label for="cpassCust" style="top: 22px;">
                                                    Confirm Password<asp:RequiredFieldValidator ID="RequiredFieldValidator7" class="redstar" runat="server" ErrorMessage="*" ControlToValidate='cpassCust' ValidationGroup="a"></asp:RequiredFieldValidator></label>
                                    ...
                                    <div class="tab-pane fade " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="form-block">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group last mb-4">
                                                        <label for="eidVend">Email ID
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="eidVend" ValidationGroup="b"></asp:RequiredFieldValidator>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" class="redstar" ErrorMessage="Invalid Email ID" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="eidVend"></asp:RegularExpressionValidator>
                                                        </label>
                                                ...
                                                <div class="col">
                                                    <div class="form-group last mb-4">
                                                        <label for="mobnoVend">
                                                            Mobile no
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="mobnoVend" ValidationGroup="b"></asp:RequiredFieldValidator>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                                ControlToValidate="mobnoVend"
                                                                ErrorMessage="Please enter a valid mobile number"
                                                                ValidationExpression="^[6-9]\d{9}$*" ForeColor="Red" />
                                                        </label>
                                                ...
                                                <div class="col">
                                                    <div class="form-group first">
                                                        <asp:DropDownList class="form-control" ID="category" runat="server">
                                                            ...
                                                            <asp:ListItem>Entertainers</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:CompareValidator ID="CompareValidator3" runat="server" ErrorMessage="*" ControlToValidate="category" ValueToCompare="Category" Operator="NotEqual" ForeColor="#FF3300"></asp:CompareValidator>
                            ...
                            <option>Food</option>
                                            ...
                                            <div class="form-group last mb-4">
                                                <label for="passVend">
                                                    Password
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="passVend" ValidationGroup="b"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                                        ControlToValidate="passVend"
                                                        ErrorMessage="Password should be minimum 8 digits"
                                                        ValidationExpression=".{8}.*" ForeColor="Red" />
                                                </label>
                                            ...
                                            <div class="form-group last mb-4">
                                                <label for="cpassVend" style="top: 22px;">
                                                    Confirm Password<asp:RequiredFieldValidator ID="RequiredFieldValidator15" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="cpassVend" ValidationGroup="b"></asp:RequiredFieldValidator></label>
                                                <asp:TextBox ID="cpassVend" class="form-control" runat="server" TextMode="Password"></asp:TextBox>
                                                <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="Password doesn't match" class="redstar" ControlToCompare="passVend" ControlToValidate="cpassVend"></asp:CompareValidator>
