  ...
  <div class="content my-4 mx-5 ">
    <div class="container ">
      <div class="row justify-content-center no-gutters">
         <div class="col-lg-8">
             <img src="log2.jpg" class=img-fluid alt="" />
             </div>
            ...
            <div class="col-md-12">
              <div class="form-block">
                  ...
                  <div class="form-group first">
                    <label  for="username"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="username"></asp:RequiredFieldValidator></label>
                      <asp:TextBox placeholder="Email ID" ID="username" class="form-control" runat="server"></asp:TextBox>
                    <%--<input type="text" class="form-control" id="username">--%>

                  </div>
                  <div class="form-group last mb-4">
                    <label  for="password"><asp:RequiredFieldValidator ID="RequiredFieldValidator2" class="redstar" runat="server" ErrorMessage="*" ControlToValidate="password"></asp:RequiredFieldValidator></label>
                  ...
                  <hr />
                  <p style="font-size:16px; color:black;">Don't have an account?
