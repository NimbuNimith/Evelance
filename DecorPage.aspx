<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DecorPage.aspx.cs" Inherits="Final_year_Project.DecorPage" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Decorators</title> <link rel="shortcut icon" href="logo.ico" />
    <meta charset="utf-8">
...
<meta name="viewport" content="width=device-width, initial-scale=1">-->
    <style>
        ...
        .imgbg1 {
            /* The image used */
            background-image: url("decorback2.jpg");
...
<body style="background: #1a1a1a; overflow-x: hidden;">
    ...
    <div class="imgbg1">
        <div class="caption">
            <span class="border">Decorators</span>
        </div>
    </div>
